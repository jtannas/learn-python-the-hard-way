...
Q1: If you do not understand this, go back through and use the comment trick to get it squared away in your mind. 
...
A5: 'w' = 'write'. It opens the file in a way that allows writing data to the file instead of limiting you to reading data.

Q5: If you open the file with 'w' mode, then do you really need the target.truncate()? Read the documentation for Python's open function and see if that's true.
A5: It is not needed to truncate the file - that happens as part of opening the file in write mode.
    Python 2 documentation for open(): https://docs.python.org/2/library/functions.html#open
'''