...
# Init the left side of a sentence
w = "This is the left side of..."

# Init the right side of a sentence
...
A2:
Line 13 (twice), line 22, and line 25

Q3:
Are you sure there are only four places? How do you know? Maybe I like lying.

A3:
Yes, the other insertions are for booleans and integers, not strings.
